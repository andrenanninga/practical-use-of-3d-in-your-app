...
<img src="https://i.imgur.com/FyK27Qd.png" />
...
Some things are still difficult or impossible
...
- Fonts need to be converted, create mesh out of font shapes
- Or render to canvas and use as texture
- Interaction within the 3d world
- No native or dom elements within the stage
- Accessibility
- Responsiveness, keeping everything in view
...
<div style={{ display: 'flex', flex: 1, overflow: 'hidden', flexDirection: 'row' }}>
  ...
  <iframe
    title="A 3D model"
    src="https://sketchfab.com/models/bb896a1ddaaa46d4bd17d147d0decd8c/embed?autospin=1&autostart=1&annotations_visible=0&ui_stop=1&camera=0"
    frameborder="0"
...
- *Sketchfab embed*
- premium features (remove watermark, annotation, transparency)
